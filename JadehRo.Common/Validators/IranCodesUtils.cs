...
namespace Sahand.Common.Utilities.Validators
{
    /// <summary>
    /// IranCodes Utils
    /// </summary>
    public static class IranCodesUtils
    {
        ...
        private static readonly Regex _matchIranianMobileNumber2 = new Regex(@"^(09){1}[0-9]{9}$", options: RegexOptions.Compiled | RegexOptions.IgnoreCase);
